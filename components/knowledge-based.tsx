...
const Recommendations = React.memo(() => {
  ...
  const fetchRecommendationsFromAPI = useCallback(async () => {
    try {
      ...
      const response = await axios.post(`${BASE_URL}/recommend-knowledge`, {
  ...
  useEffect(() => {
    ...
    sessionStorage.getItem("recommendations-knowledge");
  ...
  }, [searchParams, fetchRecommendationsFromAPI]);
...
Recommendations.displayName = "Recommendations-knowledge";
